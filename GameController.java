...
{
	/// State of the game.
	private final GameState_Opt7x6 game;
	/// Controller for IO.
	 ...
	 */
	public GameController(final GameState_Opt7x6 game, final IOModule io, final AIModule[] players, final int AI_time)
	{
	...
	private void callAI(final AIModule ai, final String AIName)
	{
		...
		final GameState_Opt7x6 duplicate = game.copy();
		ai.terminate = false;
